...
public class SarpaBuqueTest {
	...
	Naviera n1; 
	 ...
	 @Test
	 public void mailAShipper() {
		 assertTrue(shipper.getMails().isEmpty());
		 t1.generarOrdenExp(shipper, carga, buque, camion, chofer, turno);
		 t1.darOrdenDeInicio(buque);
